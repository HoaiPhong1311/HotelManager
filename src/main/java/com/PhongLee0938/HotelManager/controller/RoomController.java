package com.PhongLee0938.HotelManager.controller;
...
public class RoomController {
    ...
    public ResponseEntity<Response> addNewRoom(
        ...
        if (photo == null || photo.isEmpty() || roomType == null || roomType.isBlank() || roomPrice == null || BigDecimal.ZERO.compareTo(roomPrice) == 0){
            Response response = new Response();
            response.setStatusCode(400);
            response.setMessage("Please fill all the required fields (photo, roomType, roomPrice)");
